...
public class MybatisOneTest {
    ...
    public void testSelectEmployee() throws IOException {
        ...
        // 格式是：名称空间.SQL语句的id
        String statement = "com.mybatis.mapper.IUserMapper.findAll";

        // 要传入SQL语句的参数
        Integer emp_id = 1;

        // 执行SQL语句
//        Object result = sqlSession.selectOne(statement, emp_id);
    ...
    public void testHelloWorld() throws IOException {
         ...
         *   Sql语句标签的id
         */
        String statement = "com.mybatis.mapper.IEmployeeMapper.selectEmpById";
        Long emp_id = 1L;
