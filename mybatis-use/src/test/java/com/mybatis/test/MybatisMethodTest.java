...
public class MybatisMethodTest {
  ...
  public void selectByNameTest() {
    User user =sqlSession.selectOne("com.mybatis.mapper.IUserMapper.selectByUserName", "1");
  ...
  public void selectOneTest() {
    ...
    User user = sqlSession.selectOne("com.mybatis.mapper.IUserMapper.selectByUserName", "user");
    System.out.println(user);
    System.out.println("=============");
    User user2 = sqlSession.selectOne("com.mybatis.mapper.IUserMapper.selectByUserName", "user");
